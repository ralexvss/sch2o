...
def planilla_recaudada(request, pk):
    ...
    p.drawString(50, 805, str(entidad.descripcion))
    p.setFont('Courier-Bold', 10)
    p.drawString(490, 800, str(recaudacion.id))
    p.setFillColorRGB(0, 0, 0)
    p.drawString(450, 800, 'No.')
...
# Obtenemos el titulo de un libro y la portada.
    ...
    p.setFont('Courier', 5)
    p.setDash(6, 3)
    p.line(480, l-75, 550, l-75)
    p.line(50, l-80, 550, l-80)
    p.drawString(
        50, l-85, "Copyright © 2019 www.asoftel.com | Ing. Alex Vega | 0996844169")
