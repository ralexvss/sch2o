...
class Medidor(ClaseModelo):
    ...
    numero = models.CharField(
        verbose_name="Número medidor", max_length=50, unique=True)
    descripcion = models.CharField(
        verbose_name="Descripcion", max_length=254, null=True, blank=True)
...
class Abonado(ClaseModelo):
    ...
    identificacion = models.CharField(
        "Identificación", max_length=13, unique=True)
    ...
    fecha_nacimiento = models.DateField(
        verbose_name='Fecha de Nacimieno', null=True, blank=True)
    HOMBRE = 'H'
    MUJER = 'M'
    TIPO_SEXO = [
        (HOMBRE, 'Hombre'),
    ...
    barrio = models.ForeignKey(
        "barrio", verbose_name="Barrio / Sector", on_delete=models.CASCADE)
    foto = models.ImageField(verbose_name='Retrato', upload_to='parametro/abonado/',
...
class Catastro(ClaseModelo):
    ...
    abonado = models.ForeignKey(
        "Abonado", verbose_name="Abonado", on_delete=models.CASCADE)
    medidor = models.OneToOneField(
        "Medidor", verbose_name="Medidor", on_delete=models.CASCADE)
    servicio = models.ForeignKey(
        "parametro.Servicio", verbose_name="Servicio", on_delete=models.CASCADE)
    pago = models.ForeignKey(
        "parametro.Pago", verbose_name="Forma de pago", on_delete=models.CASCADE)
    descuento = models.ForeignKey(
        "parametro.Descuento", verbose_name="Descuento", on_delete=models.CASCADE)
    descripcion = models.CharField(
        "descripcion", max_length=254, blank=True, null=True)
...
class LecturaDetalle(ClaseModelo):
    ...
    lectura = models.ForeignKey(
        "Lectura", verbose_name="Lectura", on_delete=models.CASCADE)
    catastro = models.ForeignKey(
        "Catastro", verbose_name="Clave catastral", on_delete=models.CASCADE)
    ...
    tarifa = models.ForeignKey(
        Tarifa, verbose_name="Tarifa", on_delete=models.CASCADE)
    ...
    tipo_lectura = models.ForeignKey(
        "TipoLectura", verbose_name="Tipo de lectura", on_delete=models.CASCADE)
    ...
    valor_excedente = models.DecimalField(
        "Valor por excedente", max_digits=10, decimal_places=2, default=0)
    ...
    peticionario = models.CharField(
        "Peticionario", max_length=7, null=True, blank=True)
    ...
    def save(self):
        ...
        self.total = float(self.base)+float(self.base_reserva)+float(self.valor_excedente) + \
            float(self.valor_consumo_maximo)+float(self.administracion) + \
...
class MultaDetalle(ClaseModelo):
    ...
    lectura_detalle = models.ForeignKey(
        LecturaDetalle, verbose_name="Lectura Detalle", on_delete=models.CASCADE)
    lectura = models.IntegerField("Lectura")
    catastro = models.IntegerField("Catastro")
    multa = models.ForeignKey(
        Multa, verbose_name="Multa", on_delete=models.CASCADE)
