...
from .views import (
    ...
    LecturaList, lecturaEmitidasList, lecturaDetalleEmitidasList, lecturaFaltaIngresar, LecturaDelete, lectura_inactivar, lectura, 
    LecturaDetalleList, LecturaDetalleDelete, lecturaFaltanIngresarList,
...
urlpatterns = [
    ...
    path('catastros/toma_lecturas/', toma_lectura_list, name='toma_lecturas'),
     ...
     path('lecturas/faltaningresar/', lecturaFaltanIngresarList, name='lectura_faltan_ingresar'),
     path('lecturas/emitidas/', lecturaEmitidasList, name='lectura_emitidas'),
     path('lecturas/detalleemitidas/<int:lectura_id>', lecturaDetalleEmitidasList, name='lectura_detalle_emitidas'),
     path('lecturas/lecturafaltaingresar/<int:lectura_id>', lecturaFaltaIngresar, name='lectura_falta_ingresar'),
